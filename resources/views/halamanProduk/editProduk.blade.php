...
<form method="post" action="/produk/{{$produk->id_produk}}">
   ...
   <div class="col-md-5 offset-md-1">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="value" name="value" value="{{ $produk->value }}">
        </div>

        <div class="form-group">
            <label for="keterangan_produk">Keterangan Produk</label>
            <input type="text" class="form-control" id="keterangan_produk" name="keterangan_produk" value="{{ $produk->keterangan_produk }}">
        </div>
